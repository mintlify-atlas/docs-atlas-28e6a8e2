---
title: "Library directories: curated memory and knowledge stores"
sidebarTitle: "Library Directories"
description: "The `memory/` and `knowledge/` library directories — entry schema, namespaces, delivery types, and why the two stores must never be merged."
---
