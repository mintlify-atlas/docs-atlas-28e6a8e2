...
<Steps>
  <Step title="Copy and customize the example config">
  ...
  <Step title="Or use the example webhook script directly">
...
<Card title="Auto-embed for vector stores" icon="database">
